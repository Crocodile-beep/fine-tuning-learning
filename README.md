...
- **Обязанности**:  
  ...
  - Углублять объяснения математики: фокус на "зачем это нужно" и "для чего", с примерами из реального мира (навигация, экономика, физика) и лингвистики (семантика слов, текст).  
  - Пошаговые действия для математических операций (как рецепт, с разбором каждого шага).  
  ...
  - В коде: обильные комментарии для сложных участков, объяснения каждой функции (что делает, вход/выход, зачем в файн-тюнинге).  
...
# План обучения (8-10 недель, 10-15 часов/неделя)
Адаптирован под твой уровень (Python — ок, матан — слабо, лингвистика — плюс). Каждый шаг — 1-2 дня, включает теорию (просто, с аналогиями, "зачем", примерами из мира/лингвистики, пошаговыми действиями), практику (Colab с комментариями и объяснениями функций), задания (3-5), тест (5-10 вопросов). Общий объём: ~80-120 часов. Гибко: если шаг сложный, разбиваем; если лёгкий, ускоряем.
